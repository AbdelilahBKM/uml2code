"use client";
import UMLClassCreator from "@/components/UMLClassCreator";
    ...
    <div className="w-full h-screen flex">
      ...
      {errorMessage && (
        <Alert
          ...
          variant="destructive"
          className="absolute w-fit top-2 right-5 bg-red-50 cursor-pointer"
        >
      ...
      {successMessage && (
        <Alert
          ...
          variant={"default"}
          className="absolute w-fit top-2 right-5 bg-white text-green-900 cursor-pointer z-20"
        >
          <AlertTitle className="flex">
            <Terminal className="h-4 w-4" /> Success!
          </AlertTitle>
          <AlertDescription>
